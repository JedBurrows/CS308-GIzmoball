...
public class RightFlipper extends AbstractGizmo implements IGizmo {
    ...
    public void createLines(double tickTime) {
        ...
        if (tempL.get(0).p2().x() > (xpos + 2.0) && rotation == 0) {
            lineSegments.clear();
            lineSegments.add(new LineSegment(xpos +2.0, ypos + 0.25, xpos+2.0, ypos + 1.75)); //1
            lineSegments.add(new LineSegment(xpos + 1.5, ypos + 0.25, xpos + 1.5, ypos + 1.75)); //2
        ...
        //rotation 1
        else if (tempL.get(0).p2().y() > ypos + 2.0 && rotation == 1) {
            lineSegments.clear();
        ...
        } else if (tempL.get(1).p2().x() > (xpos + 2.0) && rotation == 1) {
            lineSegments.clear();
        ...
        //rotation 2
        else if (tempL.get(0).p2().x() < xpos && rotation == 2) {
            lineSegments.clear();
        ...
        //rotation 3
        else if (tempL.get(0).p2().y() < (ypos) && rotation == 3) {
            lineSegments.clear();
